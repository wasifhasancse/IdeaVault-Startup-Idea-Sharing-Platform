...
const STATS = [
  {
    ...
    icon: FiThumbsUp,
    tip: "Ideas you've supported",
    color: "text-[#5e41de] dark:text-[#a78bfa]",
    bg: "bg-[#5e41de]/10 dark:bg-[#5e41de]/20",
  },
  {
    label: "Comments Made",
    value: COMMENTED.length,
    icon: FiMessageSquare,
    tip: "Discussions you've joined",
    color: "text-[#5e41de] dark:text-[#a78bfa]",
    bg: "bg-[#5e41de]/10 dark:bg-[#5e41de]/20",
  },
  {
    label: "Total Interactions",
    value: UPVOTED.length + COMMENTED.length,
    icon: FiZap,
    tip: "Your community activity",
    color: "text-[#5e41de] dark:text-[#a78bfa]",
    bg: "bg-[#5e41de]/10 dark:bg-[#5e41de]/20",
  },
];
    ...
    <section className="relative min-h-screen overflow-hidden bg-linear-to-br from-white via-[#5e41de]/5 to-[#a78bfa]/10 py-10 dark:from-zinc-950 dark:via-[#5e41de]/10 dark:to-[#a78bfa]/5 md:py-14 lg:py-16">
      ...
      <div className="relative mx-auto max-w-11/12">
        ...
        <div className="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
          {STATS.map(({ label, value, icon: Icon, tip, color, bg }) => (
            <div
              key={label}
